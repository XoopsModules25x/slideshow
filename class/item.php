...
class slideshowItemHandler extends \XoopsPersistableObjectHandler
{
    ...
    public function uploadimg($image)
    {
        ...
        $uploader_img = new XoopsMediaUploader(
            XOOPS_ROOT_PATH . '/uploads/slideshow/image/', xoops_getModuleOption('img_mime', 'slideshow'), xoops_getModuleOption('img_size', 'slideshow'), xoops_getModuleOption('img_maxwidth', 'slideshow'), xoops_getModuleOption('img_maxheight', 'slideshow')
        );
